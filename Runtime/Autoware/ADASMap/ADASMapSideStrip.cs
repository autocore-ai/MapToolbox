...
{
    class ADASMapSideStrip : ADASMapElement<ADASMapSideStrip>
    {
        ...
        public override string ToString() => $"{ID},{Line.ID},{LinkLane.ID}";
        const string file = "sidestrip.csv";
